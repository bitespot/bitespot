<x-guest-layout>
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 py-8 px-4">
        <div class="w-full max-w-3xl bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-10 md:p-12 flex flex-col md:flex-row gap-8 md:gap-0 md:items-center">
